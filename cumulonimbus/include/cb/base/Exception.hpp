...
#		define DetailedException(Base, Name, message)\
		...
		DetailedException(Common, AddFailed, "Failed to add an object to a container.");
		DetailedException(Common, RemoveFailed, "Failed to remove an object from a container.");
		...
		DetailedException(File, FileUnexpectedEndOfFile, "Unexpected end of file.");
