...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpCmdLine, int nShowCmd) {
	//Abre um terminal de texto
	AllocConsole();

	//Redireciona a saida padrão para ser imprimida no terminal de texto
	...
	*stdout = *hf_out;
	...
	//Redireciona a entrada padrão para ser feita pelo terminal de texto
