	...
	namespace input {
		...
		public:
			...
			/**
				...
				*/
			void setBufferSize(DWORD isize);
			...
			/**
				...
				*/
			DWORD getBufferSize() const {return _buffer_size;}
			...
			/**
				...
				*/
			DWORD getData(DIDEVICEOBJECTDATA **odata);
			...
			/**
				...
				*/
			void setProperty(REFGUID iprop, DWORD iobj, DWORD ihow, DWORD idata);
			...
			/**
				...
				*/
			UINT_PTR getProperty(REFGUID iprop, DWORD iobj, DWORD ihow) const;
		};
	}  // namespace input
}  // namespace cb
