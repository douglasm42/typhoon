...
namespace cb {
	namespace data {
		...
		public:
			Bitmap()
			: _width(0), _height(0), _pitch(0), _bytes_per_pixel(0), _format(bmp::Format::Void), _type(bmp::Type::Void), _data(NULL) {
			}
		...
		//Signed Byte
		typedef BitmapBase<math::int8, bmp::Format::Luminance, bmp::Type::Byte> bBitmapL;
		...
		//Unsigned Byte
		typedef BitmapBase<math::uint8, bmp::Format::Luminance, bmp::Type::UByte> ubBitmapL;
		...
		//Signed Short
		typedef BitmapBase<math::int16, bmp::Format::Luminance, bmp::Type::Int16> sBitmapL;
		...
		//Unsigned Short
		typedef BitmapBase<math::uint16, bmp::Format::Luminance, bmp::Type::UInt16> usBitmapL;
		...
		//Signed Int
		typedef BitmapBase<math::int32, bmp::Format::Luminance, bmp::Type::Int32> lBitmapL;
		...
		//Unsigned Int
		typedef BitmapBase<math::uint32, bmp::Format::Luminance, bmp::Type::UInt32> ulBitmapL;
