					...
					for(int i=-100 ; i<100 ; i++) {
						for(int j=-100 ; j<100 ; j++) {
							...
							if(glm::abs(i)%2) {
								if(glm::abs(j)%2) {
									white = true;
									glColor4f(tango::aluminium1.r, tango::aluminium1.g, tango::aluminium1.b, 0.5f);
								} else {
									white = false;
									glColor4f(tango::aluminium6.r, tango::aluminium6.g, tango::aluminium6.b, 0.5f);
								}
							} else {
								if(glm::abs(j)%2) {
									white = false;
							...
							if(true) {
								glVertex3f((i+0)*0.1f, 0.0f, (j+0)*0.1f);
								glVertex3f((i+0)*0.1f, 0.0f, (j+1)*0.1f);
								glVertex3f((i+1)*0.1f, 0.0f, (j+1)*0.1f);

								glVertex3f((i+1)*0.1f, 0.0f, (j+0)*0.1f);
								glVertex3f((i+0)*0.1f, 0.0f, (j+0)*0.1f);
								glVertex3f((i+1)*0.1f, 0.0f, (j+1)*0.1f);
							}
						}
